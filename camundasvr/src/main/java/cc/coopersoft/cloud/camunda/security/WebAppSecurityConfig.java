...
//        filterRegistration.setInitParameters(Collections.singletonMap("authentication-provider", "cc.coopersoft.cloud.camunda.security.filter.webapp.SpringSecurityAuthenticationProvider"));
